	...
	<form method="post" action="" enctype="multipart/form-data" class="item-form defaultForm form-horizontal">
        <div class="well">
            ...
            <div class="item-field form-group">
                ...
                <div class="col-lg-3">
                    <input type="text" name="sort_order" value="{if $hItem.item_order}{$hItem.item_order|escape:'intval'}{/if}">
                </div>
            </div>
            <div class="item-field form-group">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label">{l s='Enable footer' mod='tmsocialfeed'}</label>
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_footer" id="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_footer_on" value="1" {if $hItem.item_footer} checked="checked"{/if}>
                        <label for="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_footer_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='tmsocialfeed'}
                        </label>
                        <input type="radio" name="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_footer" id="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_footer_off" value="0" {if !$hItem.item_footer} checked="checked"{/if}>
                        <label for="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_footer_off" class="radioCheck">
                            <i class="color_danger"></i> {l s='No' mod='tmsocialfeed'}
                        </label>
                        <a class="slide-button btn"></a>
                    </span>
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label">{l s='Show replies' mod='tmsocialfeed'}</label>
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label">{l s='Show scroll' mod='tmsocialfeed'}</label>
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label">{l s='Show background' mod='tmsocialfeed'}</label>
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_background" id="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_background_on" value="1" {if $hItem.item_background} checked="checked"{/if}>
                        <label for="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_background_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='tmsocialfeed'}
                        </label>
                        <input type="radio" name="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_background" id="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_background_off" value="0" {if !$hItem.item_background} checked="checked"{/if}>
                        <label for="{$hItem.item_type|escape:'html'}_{$hook|escape:'html'}_background_off" class="radioCheck">
                            <i class="color_danger"></i> {l s='No' mod='tmsocialfeed'}
                        </label>
                        <a class="slide-button btn"></a>
                    </span>
