	...
	<form method="post" action="" enctype="multipart/form-data" class="item-form defaultForm form-horizontal">
        <div class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="{$type|escape:'html'}_{$hook|escape:'html'}_footer" id="{$type|escape:'html'}_{$hook|escape:'html'}_footer_on" value="1" checked="checked">
                        <label for="{$type|escape:'html'}_{$hook|escape:'html'}_footer_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='tmsocialfeed'}
                        </label>
                        <input type="radio" name="{$type|escape:'html'}_{$hook|escape:'html'}_footer" id="{$type|escape:'html'}_{$hook|escape:'html'}_footer_off" value="0">
                        <label for="{$type|escape:'html'}_{$hook|escape:'html'}_footer_off" class="radioCheck">
                            <i class="color_danger"></i> {l s='No' mod='tmsocialfeed'}
                        </label>
                        <a class="slide-button btn"></a>
                    </span>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="{$type|escape:'html'}_{$hook|escape:'html'}_scroll" id="{$type|escape:'html'}_{$hook|escape:'html'}_scroll_on" value="1" checked="checked">
                        <label for="{$type|escape:'html'}_{$hook|escape:'html'}_scroll_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='tmsocialfeed'}
                        </label>
                        <input type="radio" name="{$type|escape:'html'}_{$hook|escape:'html'}_scroll" id="{$type|escape:'html'}_{$hook|escape:'html'}_scroll_off" value="0">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="{$type|escape:'html'}_{$hook|escape:'html'}_background" id="{$type|escape:'html'}_{$hook|escape:'html'}_background_on" value="1" checked="checked">
                        <label for="{$type|escape:'html'}_{$hook|escape:'html'}_background_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='tmsocialfeed'}
                        </label>
                        <input type="radio" name="{$type|escape:'html'}_{$hook|escape:'html'}_background" id="{$type|escape:'html'}_{$hook|escape:'html'}_background_off" value="0">
                        <label for="{$type|escape:'html'}_{$hook|escape:'html'}_background_off" class="radioCheck">
                            <i class="color_danger"></i> {l s='No' mod='tmsocialfeed'}
                        </label>
                        <a class="slide-button btn"></a>
                    </span>
