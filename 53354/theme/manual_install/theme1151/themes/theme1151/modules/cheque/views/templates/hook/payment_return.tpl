{if $status == 'ok'}
    ...
    <div class="box order-confirmation">
		...
		<br />- {l s='For any questions or for further information, please contact our' mod='cheque'} <a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}" title="{l s='customer service department.' mod='cheque'}">{l s='customer service department.' mod='cheque'}</a>.
	</div>
{else}
