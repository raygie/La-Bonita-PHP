{if $status == 'ok'}
	<div class="box">
		...
		<br />{l s='If you have questions, comments or concerns, please contact our' mod='bankwire'} <a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}" title="{l s='expert customer support team. ' mod='bankwire'}">{l s='expert customer support team' mod='bankwire'}</a>.
	</div>
{else}
