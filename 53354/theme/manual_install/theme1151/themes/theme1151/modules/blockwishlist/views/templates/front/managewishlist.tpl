    ...
    {if !$refresh}
        ...
        <p class="submit">
        	<div id="showSendWishlist">
                <a class="btn btn-default btn-sm" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
                        ...
                        <div class="col-xs-6 col-sm-12">
                            <div class="product_infos">
                                ...
                                <div class="btn_action">
                                    <a class="btn btn-default btn-sm"  href="javascript:;" onclick="WishlistProductManage('wlp_bought_{$product.id_product_attribute}', 'update', '{$id_wishlist}', '{$product.id_product}', '{$product.id_product_attribute}', $('#quantity_{$product.id_product}_{$product.id_product_attribute}').val(), $('#priority_{$product.id_product}_{$product.id_product_attribute}').val());" title="{l s='Save' mod='blockwishlist'}">
    ...
    {if !$refresh}
        <form method="post" class="wl_send box unvisible" onsubmit="return (false);">
            ...
            <fieldset>
                ...
                {/section}
                <div class="submit">
                    <button class="btn btn-default btn-sm" type="submit" name="submitWishlist"
                            ...
                            <tr>
                                <td class="first_item">
									<span style="float:left;">
										<img src="{$link->getImageLink($product.link_rewrite, $product.cover, 'small')|escape:'html':'UTF-8'}" alt="{$product.name|escape:'html':'UTF-8'}"/>
									</span>			
									<span style="float:left;">
