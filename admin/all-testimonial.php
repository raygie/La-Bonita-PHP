                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <div class="modal-body">
                                        <form action="includes/updatetestimonial.php" method="post" class="row g-3" autocomplete="off" enctype="multipart/form-data" >
                                          ...
                                          <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="edit_input_testi" rows="5" name="edit_input_testi" ><?php echo $prod['input_testi']?></textarea>
                                          </div>
                                          ...
                                          <label for="testi_image" class="form-label">New Image</label>
                                          <input class="fadfa" type="file" id="testi_image" name="testi_image" value="<?php echo $prod['testi_image']?>">
                                          </div>
                                          <hr>
