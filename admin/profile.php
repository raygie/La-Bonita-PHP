                                ...
                                <div class="card-body pt-3">
                                    <div class="tab-content pt-2">
                                        <div class="tab-pane fade show active profile-overview pt-3" id="profile-name">
                                            <div class="row mb-3">
                                                <label for="newName" class="col-md-4 col-lg-3 col-form-label">New
                                                    Name</label>
                                            ...
                                            <div class="row mb-3">
                                                <label for="renewName" class="col-md-4 col-lg-3 col-form-label">Re-enter
                                                    New Name</label>
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="renewName" type="text" class="form-control"
                                                        id="renewName" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" id="changeName">Change
                                                    Name</button>
                                            </div>
                                ...
                                <div class="card-body pt-3">
                                    <div class="tab-content pt-2">
                                        <div class="tab-pane fade show active pt-3" id="profile-change-password">
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-primary" id="changePassword">Change
                                                    Password</button>
                                            </div>
    ...
    $(document).ready(function() {
        $('#changeImage').click(function() {
            ...
            $.ajax({
                ...
                method: "POST",
                data: {
                    inputprod_image: inputprod_image
                },
