    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            ?>
                        ...
                        <form action="includes/updateproduct.php" method="post" class="row g-3" autocomplete="off"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="edit_inputprod_name"
                                    name="edit_inputprod_name" value="<?php echo $prod['prod_name'] ?>" required />
                            </div>
                            <div class="col-md-6">
                                <label for="edit_inputprod_price" class="form-label">Product Price</label>
                                <input type="text" class="form-control" id="edit_inputprod_price"
                                    name="edit_inputprod_price" value="<?php echo $prod['prod_price'] ?>" required />
                            </div>
                            <div class="col-md-6">
                                <label for="edit_inputprod_link" class="form-label">Link</label>
                                <input type="text" class="form-control" id="edit_inputprod_link"
                                    name="edit_inputprod_link" value="<?php echo $prod['link'] ?>" required />
                            </div>
                            <div class="col-md-6">
                                <label for="edit_inputprod_category" class="form-label">Category</label>
                                <select id="edit_inputprod_category" name="edit_inputprod_category"
                                    class="form-control">
                                    ...
                                    <option value="Others"
                                        <?php if ($prod['prod_category'] == 'Others') echo 'selected' ?>>Others</option>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <label for="edit_inputprod_desc" class="form-label">Description</label>
                                <textarea class="form-control" id="edit_inputprod_desc" rows="5"
                            ...
                            <div class="col-md-12 mt-3 mb-3">
                                ...
                                <input class="fadfa" type="file" id="prod_image" name="prod_image"
