...
<link rel="stylesheet" href="Testimonials.css" media="screen">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-custom-color-3 u-header u-sticky u-header" id="sec-3417"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-custom-color-3 u-section-1" id="sec-e828">
            ...
            <?php
              ...
              <div class="u-container-style u-layout-cell u-size-20 u-layout-cell-1">
                ...
                <?php echo '<img src="admin/includes/testipic/' . $row['testi_image'] . '" alt="Avatar" class="u-image u-image-circle u-preserve-proportions u-image-1" data-image-width="500" data-image-height="500">' ?>
                  <h6 class="u-align-justify u-custom-font u-font-montserrat u-text u-text-2">  “<?php echo $row['input_testi'] ?>”<br>
                  </h6>
                  <h5 class="u-align-center u-custom-font u-font-montserrat u-text u-text-custom-color-5 u-text-3"><?php echo $row['input_name'] ?></h5>
