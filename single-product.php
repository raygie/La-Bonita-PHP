  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-custom-color-3 u-header u-sticky u-header" id="sec-3417"><div class="u-clearfix u-sheet u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-custom-color-3 u-section-2" id="sec-bb70">
        <div class="u-clearfix u-sheet u-sheet-1">
                ...
                <p class="u-align-justify u-custom-font u-font-montserrat u-large-text u-text u-text-variant u-text-2"><?= $fetch['prod_desc'];?></p>
                <div class="u-price u-text-custom-color-5"
                                        style="font-size: 1.5rem; font-weight: 700; margin-top: 20px"><?= $fetch['prod_price'];?>
                                    </div>
                <!-- <p class="u-text u-text-3"><?= $fetch['prod_price'];?></p> -->
                <a target="_blank" href="<?= $fetch['link'];?>" class="u-border-2 u-border-custom-color-5 u-btn u-btn-round u-button-style u-custom-font u-font-montserrat u-hover-custom-color-4 u-none u-radius-10 u-text-hover-white u-btn-1">BUY NOW</a>
        </div>
    </section>
