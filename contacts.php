            ...
            <div class="u-social-icons u-spacing-20 u-social-icons-1">
                ...
                <a class="u-social-url" target="_blank" href="https://www.instagram.com/la_bonita_cosmetics/" title="Instagram"><span class="u-icon u-icon-circle u-social-icon u-social-instagram u-text-custom-color-5 u-icon-4">
                        ...
                        <svg x="0px" y="0px" viewBox="0 0 112.2 112.2" style="enable-background:new 0 0 112.2 112.2;" xml:space="preserve" id="svg-1dc5" class="u-svg-content">
                            <path d="M56.1,0C25.1,0,0,25.1,0,56.1c0,31,25.1,56.1,56.1,56.1c31,0,56.1-25.1,56.1-56.1C112.2,25.1,87.1,0,56.1,0z M90.6,73.4c0,9.6-7.8,17.5-17.5,17.5H38.6c-9.6,0-17.5-7.9-17.5-17.6V38.8c0-9.6,7.8-17.5,17.5-17.5h34.5c9.6,0,17.5,7.8,17.5,17.5 V73.4z">
                            </path>
                            ...
                            <path d="M55.9,45.8c-5.7,0-10.4,4.6-10.3,10.3c0,5.7,4.6,10.3,10.3,10.3s10.3-4.6,10.3-10.3 C66.2,50.4,61.6,45.8,55.9,45.8z">
                            </path>
                        </svg>
                    </span>
                </a>
                                        ...
                                        <div class="u-expanded-width u-form u-form-1">
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="u-form-group u-form-select u-form-group-3">
                                                    <label for="select-24cd" class="u-custom-font u-font-montserrat u-label">Message
                                                        Type:</label>
                                                    <div class="u-form-select-wrapper">
                                                        <select id="select-24cd" name="subject" class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle u-radius-10">
                                                ...
                                                <div class="u-form-group u-form-message">
                                                    ...
                                                    <textarea placeholder="Enter your message" rows="4" cols="50" id="message-e4cc" name="msg" class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle u-radius-10" required=""></textarea>
                                                </div>
                                                <br>
