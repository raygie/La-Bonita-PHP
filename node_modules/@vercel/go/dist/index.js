...
`);
    ...
    let downloadedFiles = await build_utils_1.download(files, downloadPath, meta);
    ...
    try {
        ...
        if (fileName in downloadedFiles) {
            ...
            build_utils_1.debug(`Found ${fileName} file in "${goModAbsPathDir}"`);
        }
...
Learn more: https://vercel.com/docs/runtimes#official-runtimes/go
    ...
    if (meta.isDev) {
        ...
        await build_utils_1.download(downloadedFiles, destLambda);
        downloadedFiles = await build_utils_1.glob('**', destLambda);
    ...
    for (const file of Object.keys(downloadedFiles)) {
        ...
        if (file === 'go.mod') {
            ...
            if (!isGoModInRootDir && config.zeroConfig && file === 'api/go.mod') {
                ...
                build_utils_1.debug(`Moving api/go.mod to root: ${fsPath} to ${newFsPath}`);
    ...
    build_utils_1.debug(`Found exported function "${handlerFunctionName}" in "${entrypoint}"`);
