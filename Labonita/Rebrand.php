...
<head>
  ...
  <link rel="stylesheet" href="Rebrand.css" media="screen">
  ...
  <meta name="twitter:title" content="Rebrand">
  <meta name="twitter:description" content="Labonita">
  <meta property="og:title" content="Rebrand">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-align-center u-clearfix u-custom-color-3 u-section-2" id="sec-499c">
        ...
        <div class="u-repeater u-repeater-1">
          ...
          <div
            ...
            <div class="u-container-layout u-similar-container u-container-layout-1">
              <!--product_image-->
              <img alt="" class="u-hover-feature u-image u-image-round u-product-control u-radius-23 u-image-1"
                src="images/35.svg">
              <!--/product_image-->
              <!--product_title-->
              ...
              <!--/product_title-->
              <!--product_content-->
              <div class="u-custom-font u-font-montserrat u-product-control u-product-desc u-text u-text-3">
                <!--product_content_content-->Sample small text. Lorem ipsum dolor sit amet.
                <!--/product_content_content-->
              </div>
              <!--/product_content-->
              <!--product_price-->
              <div class="u-custom-font u-font-montserrat u-product-control u-product-price u-product-price-1">
                <div class="u-price-wrapper u-spacing-10">
                  ...
                  <div class="u-price u-text-custom-color-5" style="font-size: 1.5rem; font-weight: 700;">
          ...
          <div
            ...
            <div class="u-container-layout u-similar-container u-container-layout-2">
              <!--product_image-->
              <img alt="" class="u-hover-feature u-image u-image-round u-product-control u-radius-23 u-image-2"
                src="images/36.svg">
              <!--/product_image-->
              <!--product_title-->
              ...
              <!--/product_title-->
              <!--product_content-->
              <div class="u-custom-font u-font-montserrat u-product-control u-product-desc u-text u-text-5">
                <!--product_content_content-->Sample small text. Lorem ipsum dolor sit amet.
                <!--/product_content_content-->
              </div>
              <!--/product_content-->
              <!--product_price-->
              <div class="u-custom-font u-font-montserrat u-product-control u-product-price u-product-price-2">
                <div class="u-price-wrapper u-spacing-10">
                  <!--product_old_price-->
                  <div class="u-hide-price u-old-price">
                    <!--product_old_price_content-->$12
          ...
          <div
            ...
            <div class="u-container-layout u-similar-container u-container-layout-3">
              <!--product_image-->
              <img alt="" class="u-hover-feature u-image u-image-round u-product-control u-radius-23 u-image-3"
                src="images/37.svg">
              <!--/product_image-->
              <!--product_title-->
              ...
              <!--/product_title-->
              <!--product_content-->
              <div class="u-custom-font u-font-montserrat u-product-control u-product-desc u-text u-text-7">
                <!--product_content_content-->Sample small text. Lorem ipsum dolor sit amet.
                <!--/product_content_content-->
              </div>
              <!--/product_content-->
              <!--product_price-->
              <div class="u-custom-font u-font-montserrat u-product-control u-product-price u-product-price-3">
                <div class="u-price-wrapper u-spacing-10">
                  <!--product_old_price-->
                  <div class="u-hide-price u-old-price">
                    <!--product_old_price_content-->$12
